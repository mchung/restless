...
public class DeleteItemService extends AbstractBoxService<DeleteItemResult> {

    protected final static String RESOURCE      = "DeleteItemService.xml";
    ...
    @Override
    protected DeleteItemResult doParseXml(final String pXmlStr) throws MalformedXmlException {
        ...
        try {
            ...
            throw new MalformedXmlException("Couldn't delete item.", mxe.getCause());
        }
