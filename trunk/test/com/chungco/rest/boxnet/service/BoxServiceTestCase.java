...
public class BoxServiceTestCase extends TestCase {
    ...
    private MockLoginPassword   provider       = new MockLoginPassword();
    ...
    public BoxServiceTestCase(final String pMethodName) {
    ...
    public static Test suite() {
        ...
        suite.addTest(new BoxServiceTestCase("testAuthorization"));
        suite.addTest(new BoxServiceTestCase("testFileUpload"));
        suite.addTest(new BoxServiceTestCase("testFileDownload"));
        suite.addTest(new BoxServiceTestCase("testFolderCreation"));
        suite.addTest(new BoxServiceTestCase("testFileListing"));
