...
public class FileListingService extends AbstractBoxService<FileListingResult> {
    ...
    protected final static String KEY_FOLDER_ID = "folder_id_here";

    protected final static String KEY_ONE_LEVEL = "one_level";

    protected final static String RESOURCE      = "FileListingService.xml";
        ...
        final IXmlSaxParser sax2 = new IXmlSaxParser() {
            ...
            public void startElement(final XmlElement pXml, final Stack<XmlElement> pParents) {
                ...
                if (BoxFolder.XML_FOLDER.equals(xmlKey)) {
                    ...
                    // TODO Implement when documented
                    // final XmlElement xml = pParents.peek();
                    // if (xml.key().equals(File.__KEY_FILE)) {
                    // System.out.println("Got a <tags> for a <file>");
                    // } else if (xml.key().equals(Folder.__KEY_FOLDER)) {
                    // System.out.println("Got a <tags> for a <folder>");
                    // }
